...
class LeadDetails extends StatelessWidget {
  ...
  decoration: BoxDecoration(
    ...
    border: Border.all( // Adding an outline border
      color: Color(0XFFD4D7E3), // You can change the color to whatever you want
...
Padding(
  ...
  child: Row(
    children: [
      ...
      SizedBox(width: context.screenWidth*0.08,),
      const Text('Phone No:',style: TextStyle(fontWeight: FontWeight.bold)),
...
Row(
  ...
  child: Row(
    children: [
      ...
      const Text('Travel Date:',style: TextStyle(fontWeight: FontWeight.bold),),
       SizedBox(width: context.screenWidth*0.05,),
...
const Divider(endIndent: 18,indent: 18,),
 ...
 Padding(
  ...
  child: Row(
    children: [
      const Text('Package Amount:',style: TextStyle(fontWeight: FontWeight.bold),),
      SizedBox(width:context.screenWidth*0.06,),

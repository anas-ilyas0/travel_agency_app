...
class MobileInternationalSupplierDetails extends StatelessWidget {
  const MobileInternationalSupplierDetails({super.key});
                    ...
                    children: [
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          width: 35,
                          child: Image(
                            image: AssetImage('${imageUrl}supplier_avatar.png'),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),

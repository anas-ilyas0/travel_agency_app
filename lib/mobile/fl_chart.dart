...
// import 'package:flutter/material.dart';
//
// class FlChart{  // Renamed to avoid conflicting with FlChart class from the package
//   static Widget flChart(BuildContext context) {  // Pass context here
//     bool isBoldText = MediaQuery.of(context).boldText;  // Correct usage of MediaQuery
//
//     return Padding(
//       padding: const EdgeInsets.symmetric(horizontal: 15),
//       child: Container(
...
//                         showTitles: true,
//                         getTextStyles: (context, value) => TextStyle(
//                           fontWeight: isBoldText ? FontWeight.bold : FontWeight.w400,  // Adjust font weight
//                           fontSize: 11,
//                           fontFamily: readexPro,
//                         ),

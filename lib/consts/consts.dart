...
final fontFamilys = AppStrings.fontFamily;
...
final editDelContainerColor = AppStrings.editDelContainerColor;
final containerColor = AppStrings.containerColor;
final imageUrl = AppStrings.imageUrl;
final finalButtonTextColor = AppStrings.finalButtonTextColor;
final mobileLeadText1Color = AppStrings.mobileLeadText1Color;
final cancelButtonColor  = AppStrings.cancelButtonColor;
class AppStrings {
  ...
  static String ReadexPro = 'ReadexPro';
  static String Poppin = 'Poppin';
  static const String appName ="Travel Agency";
  ...
  static Color editDelContainerColor = const Color(0XFFFAFBFD);
  static Color containerColor = const Color(0XFFDEF8FF);
